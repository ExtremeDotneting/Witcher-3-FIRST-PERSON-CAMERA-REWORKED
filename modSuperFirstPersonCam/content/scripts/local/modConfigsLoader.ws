...
function FP_IsEnabled_UsingHorse():bool{
		//Crunch for horse
	return theGame.GetInGameConfigWrapper().GetVarValue('fps_mod_configs', 'Enable_in_UsingHorse') && theGame.GetInGameConfigWrapper().GetVarValue('fps_mod_configs', 'Enable');
}
